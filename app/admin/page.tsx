...
import { getExpectedAdminEmail, getExpectedAdminPassword, AUTH_KEY } from "@/lib/admin-auth";
...
export default function AdminLoginPage() {
  ...
  useEffect(() => {
    ...
    const alreadyAuthed = window.localStorage.getItem(AUTH_KEY) === "1";
    if (alreadyAuthed) {
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const valid = email === getExpectedAdminEmail() && password === getExpectedAdminPassword();
